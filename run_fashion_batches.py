...
def build_parser():
    ...
    m_parser.add_argument('--lr', type=float, default=1e-3, metavar='LR',
...
if __name__ == '__main__':
    ...
    for prng_engine in prng_engines:
        ...
        for seed in seeds:
            ...
            trainer = minst_fashion_train.BaseFashionMNISTTrainer(args)
            ...
            loss_path = Path(f"results_fashion/{prng_engine}/{seed}_loss.csv")
            eval_path = Path(f"results_fashion/{prng_engine}/{seed}_evaluation.csv")
    ...
    results_path = Path(f"results_fashion/results.json")
